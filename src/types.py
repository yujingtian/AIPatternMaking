...
class BackPatternPoints:
    ...
    # =================================================================
    # ==================== 新增：后片裁片结果字段 ====================
    back_panel_outline: Optional[List[Tuple[float, float]]] = None  # 后片裁片闭合轮廓（裁片拆分）
    # =================================================================
    # ==================== 新增：后腰头裁片结果字段 ====================
    back_waistband_outline: Optional[List[Tuple[float, float]]] = None  # 后腰头裁片闭合轮廓（裁片拆分，腰省已拼合）
    # =================================================================
    # ==================== 新增：机头裁片结果字段 ====================
    jitou_panel_outline: Optional[List[Tuple[float, float]]] = None  # 机头裁片闭合轮廓（裁片拆分，腰省已拼合）
    # =================================================================
